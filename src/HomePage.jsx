    ...
    <div className="home-container flex flex-col items-center justify-center p-4 bg-black w-full min-h-screen text-white">
          ...
          {activeTab === "about" && (
            <div className="about-section">
              ...
              <p>
                ...
                <br />
                Organized by JNTU GV's CSE department, this event unites tech enthusiasts nationwide.Cresence 2K25 is more than just a tech fest—it’s a celebration of innovation, competition, and creativity.  
                Organized by the third-year students of JNTU GV's CSE department, this national-level fest brings together  
                some of the sharpest minds from across the country.
              </p>
            </div>
            ...
            <div className="rules-section">
              <div className="rules-grid flex flex-wrap justify-center gap-4">
                {[
                  ...
                  <div key={index} className="rule-box bg-white/5 p-4 rounded-lg shadow-md text-center border border-white/10 w-full sm:w-[48%] lg:w-[30%]">
                    <b className="text-lg text-blue-500">{level.title}</b>
                    <ul className="text-left pl-4 mt-2 text-sm sm:text-base">
      ...
      <div className="photo-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-center mt-6 w-full max-w-screen-lg">
        {[...Array(3)].map((_, index) => (
          <div
            key={index}
            className="grid-item w-full h-40 sm:h-90 bg-[url('/images/SquidGame.png')] bg-no-repeat bg-center bg-cover rounded-md shadow-md"
          ></div>
        ))}
      </div>

      {/* Next Button (Navigates to Level 1 Instructions) */}
      <button
